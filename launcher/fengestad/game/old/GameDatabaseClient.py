...
#                    (game_uuid,))
    ...
    def update_game(self, game_id):
        ...
        cursor.execute(self.database.query("UPDATE game SET game = %s, "
                ...
                values.get("screen5_sha1", ""), game_id))
