...
class GamePaths:
    ...
    def get_screenshot_path(self, number):
        ...
        if self.uuid:
            ...
            paths = FSUAEDirectories.get_images_dirs()
            for dir in paths:
        ...
        if number == 0:
            ...
            if override_dir:
                ...
                paths = FSUAEDirectories.get_titles_dirs()
        else:
            override_dir = Config.get("screenshots_dir")
            if override_dir:
                paths = [Paths.expand_path(override_dir)]
            else:
                paths = FSUAEDirectories.get_screenshots_dirs()
        if number >= 2:
    ...
    def get_cover_path(self):
        ...
        if override_dir:
            ...
            paths = FSUAEDirectories.get_covers_dirs()
        for dir in paths:
    ...
    def get_theme_path(self):
        ...
        if not letter:
            return None
        paths = FSUAEDirectories.get_themes_dirs()
        for dir in paths:
