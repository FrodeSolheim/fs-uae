...
void fsemu_inputport_set_mode_by_index(fsemu_inputport_t *port, int mode_index)
{
    fsemu_input_log_debug(
        "fsemu_inputport_set_mode_by_index %d for port: %s\n",
        mode_index,
        port->name);
...
static void fsemu_inputport_python_destructor(PyObject *)
{
...
static PyObject *fsemu_inputport_python_new(PyObject *self, PyObject *args)
{
    ...
    PyObject *capsule = PyCapsule_New(
        port, "fsemu_inputport_t", fsemu_inputport_python_destructor);
    return capsule;
}

static PyObject *fsemu_inputport_python_set_name(PyObject *self,
                                                 PyObject *args)
{
    PyObject *capsule;
    const char *name;
...
static PyObject *fsemu_inputport_python_add_mode(PyObject *self,
                                                 PyObject *args)
{
...
static PyObject *fsemu_inputport_python_set_device(PyObject *self,
                                                   PyObject *args)
{
    PyObject *port_capsule;
    PyObject *device_capsule;
    if (!PyArg_ParseTuple(
            args, "OO:set_device", &port_capsule, &device_capsule)) {
        return NULL;
    }
    fsemu_inputport_t *port = (fsemu_inputport_t *) PyCapsule_GetPointer(
        port_capsule, "fsemu_inputport_t");
    fsemu_inputdevice_t *device = (fsemu_inputdevice_t *) PyCapsule_GetPointer(
        device_capsule, "fsemu_inputdevice_t");
    fsemu_inputport_set_device(port, device);
    Py_RETURN_NONE;
}

static PyObject *fsemu_inputport_python_set_device_by_index(PyObject *self,
                                                            PyObject *args)
{
    PyObject *port_capsule;
    int device_index;
    if (!PyArg_ParseTuple(
            args, "Oi:set_device_by_index", &port_capsule, &device_index)) {
        return NULL;
    }
    fsemu_inputport_t *port = (fsemu_inputport_t *) PyCapsule_GetPointer(
        port_capsule, "fsemu_inputport_t");
...
static PyObject *fsemu_inputport_python_set_mode_by_index(PyObject *self,
                                                          PyObject *args)
{
    PyObject *capsule;
    int mode_index;
    if (!PyArg_ParseTuple(
            args, "Oi:set_mode_by_index", &capsule, &mode_index)) {
        return NULL;
    }
    fsemu_inputport_t *port = (fsemu_inputport_t *) PyCapsule_GetPointer(
        capsule, "fsemu_inputport_t");
...
static PyMethodDef fsemu_inputport_python_methods[] = {
    ...
    {"set_device_by_index",
     fsemu_inputport_python_set_device_by_index,
     METH_VARARGS,
     "..."},
    {"set_mode_by_index",
     fsemu_inputport_python_set_mode_by_index,
     METH_VARARGS,
     "..."},
    {NULL, NULL, 0, NULL}};

static PyModuleDef fsemu_inputport_python_module = {
