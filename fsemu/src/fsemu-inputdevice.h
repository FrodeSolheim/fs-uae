...
enum {
    ...
    FSEMU_INPUTDEVICE_SOUTH,  // FSEMU_INPUTDEVICE_A,
    FSEMU_INPUTDEVICE_EAST,   // FSEMU_INPUTDEVICE_B,
    FSEMU_INPUTDEVICE_WEST,   // FSEMU_INPUTDEVICE_X,
    FSEMU_INPUTDEVICE_NORTH,  // FSEMU_INPUTDEVICE_Y,
