...
#define fsemu_data_log(format, ...) FSEMU_LOG(data, "[FSE] [DAT]", format, ##__VA_ARGS__)
...
#define fsemu_data_log_info(format, ...) FSEMU_LOG_INFO(data, "[FSE] [DAT]", format, ##__VA_ARGS__)
