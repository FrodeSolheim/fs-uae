...
class GameInfoPanel(BottomPanel):
    ...
    def __init__(self, parent):
        ...
        self.link_buttons = {}
        # for icon_name in ["flag_red", "tick", "thumb_down_mod",
        #                   "thumb_up_mod", "rating_fav",
        #                   ]:
        #     image = fsui.Image("fs_uae_launcher:res/16/{0}.png".format(
        #         icon_name))
        #     button = fsui.ImageButton(self, image)
        #     if icon_name == "thumb_down_mod":
        #         hori_layout.add_spacer(12)
        #     hori_layout.add(button, margin_right=4, fill=True)
    ...
    def on_config(self, key, value):
        ...
        if key == "publisher":
            ...
            self.variant_rating_button.show_or_hide(bool(value))
