...
def updateConfigureAc(version: str, commit: str = "") -> None:
...
def updateDebianChangelog(version: str) -> None:
...
def updateSpecFile(path: str, version: str) -> None:
    print("Updating", path)
    lines = []
...
def updatePackageFs(version: str) -> None:
...
def updateVersionFs(version: str) -> None:
...
def updateCommitFs(version: str) -> None:
...
def updateVersion(version: str) -> None:
