...
{
	// FIXME: cast is only "necessary" because of long long int vs long int
	// FIXME: Consider making uae_u64 typedef to uint64_t instead, but this
	// will cause issues for a lot of #lld debugging calls.
