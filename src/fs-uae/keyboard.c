...
static fs_emu_key_translation g_default_keymap[] = {
    ...
    { FS_ML_KEY_F12,          ALL, FS_EMU_ACTION_MENU_ALT },
    { FS_ML_KEY_P,            MOD, FS_EMU_ACTION_PAUSE },
    { FS_ML_KEY_PAUSE,        ALL, FS_EMU_ACTION_PAUSE },
    { FS_ML_KEY_F4,           MOD, FS_EMU_ACTION_QUIT },
    { FS_ML_KEY_Q,            MOD, FS_EMU_ACTION_QUIT },
    { FS_ML_KEY_PRINT,        ALL, FS_EMU_ACTION_SCREENSHOT },
    ...
    { FS_ML_KEY_F11,          ALL, FS_EMU_ACTION_ZOOM },
