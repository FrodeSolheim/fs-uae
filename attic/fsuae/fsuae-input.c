...
static fs_emu_action g_actions[] = {
    ...
    { INPUTEVENT_SPC_SINGLESTEP, "action_singlestep", 0 },
    { INPUTEVENT_SPC_WARP, "action_warp", 0 },
    { INPUTEVENT_SPC_INHIBITSCREEN, "action_inhibitscreen", 0 },
    ...
    { INPUTEVENT_SPC_TOGGLERTG, "action_togglertg", 0 },
    { INPUTEVENT_SPC_SWAPJOYPORTS, "action_swapjoyports", 0 },
    { INPUTEVENT_SPC_PASTE, "action_paste", 0 },
